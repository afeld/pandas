...
BLOG_AUTHOR = "The pandas maintainers"  # (translatable)
BLOG_TITLE = "pandas"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pandas.pydata.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pandas.pydata.org/"
BLOG_EMAIL = "n.tesla@example.com"
BLOG_DESCRIPTION = "pandas is a fast, powerful, flexible and easy to use open source data analysis and manipulation tool,"  # (translatable)
...
blog_dest = "community/blog"
POSTS = (
    ("posts/*.rst", blog_dest, "post.tmpl"),
    ("posts/*.md", blog_dest, "post.tmpl"),
    ("posts/*.txt", blog_dest, "post.tmpl"),
